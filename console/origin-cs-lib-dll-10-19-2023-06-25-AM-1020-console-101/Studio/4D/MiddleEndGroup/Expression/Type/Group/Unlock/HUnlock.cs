...
namespace Core
{
    ...
    {
        public void HUnlock(String[] array_SPLIT)
        {
            ...
            {
                ConsoleLJS.Render($"{ConsoleLJCode.SpecialDirectoryEstelScript.Core_EstelScript_Fatal}-{nameof(HUnlock)}", String.Join('\n'.ToString(), new String[] {

                    String.Empty + nameof(Expression) + ' ' + "::" + ' ' + nameof(HUnlock) + ' ' + '{',
