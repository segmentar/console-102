...
namespace Core
{
    ...
    {
        public void HLock(String[] array_SPLIT)
        {
            ...
            {
                ConsoleLJS.Render($"{ConsoleLJCode.SpecialDirectoryEstelScript.Core_EstelScript_Fatal}-{nameof(HLock)}", String.Join('\n'.ToString(), new String[] {

                    String.Empty + nameof(Expression) + ' ' + "::" + ' ' + nameof(HLock) + ' ' + '{',
