...
namespace Core
{
    ...
    {
        public void HVUnlock(String[] array_SPLIT)
        {
            ...
            {
                ConsoleLJS.Render($"{ConsoleLJCode.SpecialDirectoryEstelScript.Core_EstelScript_Fatal}-{nameof(HVUnlock)}", String.Join('\n'.ToString(), new String[] {

                    String.Empty + nameof(Expression) + ' ' + "::" + ' ' + nameof(HVUnlock) + ' ' + '{',
