...
namespace Core
{
    ...
    {
        public void HVLock(String[] array_SPLIT)
        {
            ...
            {
                ConsoleLJS.Render($"{ConsoleLJCode.SpecialDirectoryEstelScript.Core_EstelScript_Fatal}-{nameof(HVLock)}", String.Join('\n'.ToString(), new String[] {

                    String.Empty + nameof(Expression) + ' ' + "::" + ' ' + nameof(HVLock) + ' ' + '{',
